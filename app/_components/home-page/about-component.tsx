...
const AboutComponent = () => {
  ...
  return (
    <main className="grid gap-12 py-20 bg-[url('https://ik.imagekit.io/thewrightdesigns/monks-medical/images/tr:q-55,w-450/monks-medical-51.jpg')] phone:bg-[url('https://ik.imagekit.io/thewrightdesigns/monks-medical/images/tr:q-55,w-650/monks-medical-51.jpg')] tablet:bg-[url('https://ik.imagekit.io/thewrightdesigns/monks-medical/images/tr:q-55,w-1150/monks-medical-51.jpg')] desktopSmall:bg-[url('https://ik.imagekit.io/thewrightdesigns/monks-medical/images/tr:q-55,w-1750/monks-medical-51.jpg')] -mx-7 p-7 desktopSmall:-mx-[200px] desktopSmall:px-[200px]">
