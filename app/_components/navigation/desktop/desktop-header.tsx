...
const DesktopHeader = () => {
  return (
    <header className="hidden sticky top-0 z-50 w-full desktopSmall:flex border-b-4 bg-white border-brown drop-shadow-default">
      <div className="flex w-full justify-between mx-auto max-w-[1100px] px-8 py-6 desktopSmall:bg-[url('https://ik.imagekit.io/thewrightdesigns/monks-medical/images/tr:q-55,w-1150/monks-medical-54.jpg')] bg-cover bg-center relative">
